<div id="body">
    <div id="header">
		<div id="header_content">
			<h2>Belanja - <?=$str_month." ".$str_year?></h2>
		</div>
    </div>
    ...
    <input type="button" value="&#8592; Prev Month" onclick="parent.load_belanja_view_month(<?=$prev_month?>, <?=$prev_year?>)"/>
    <input type="button" value="Next Month &#8594;" onclick="parent.load_belanja_view_month(<?=$next_month?>, <?=$next_year?>)"/>
	<br/>
	<br/>
</div>